...
1. **ChipSeqPipeline.sh**
 ...
 4. **target_genes.R**
    * Install packages ([`BiocManager`](https://cran.r-project.org/web/packages/BiocManager/vignettes/BiocManager.html))
    * Read arguments 
 ...
 5. **exp_analysis.R**
    ...
    * Extraction of overlapping replicates ([`VennDiagram`](https://cran.r-project.org/web/packages/VennDiagram/VennDiagram.pdf))
...
The pipeline is built using [`GNU nano`](https://www.nano-editor.org), a command line text editor for Unix and Linux operating systems. See Pipeline summary section for a condensed overview of the steps in the pipeline, and the bioinformatics tools used at each step.
